...
let population = 9485000;
let stadium = true;
console.log('Город: ' + name, 'Страна: ' + country, 'Население: ' + population + ' человек', 'Стадион: ' + stadium);
...
console.log('Площадь прямоуголника = ' + result + ' см2');
/* 
    Задание 3:
...
generalDistance = distanceOfFirst + distanceOfSecond;
console.log('Города находятся на расстоянии ' + generalDistance + ' км');
/* 
    Задание 4:
